...
void GPIO_Initialize()
{
	...
	GPIOA->CRL |= (GPIO_CRL_CNF1_1);   //Input Pull-up/Pull-down
	GPIOA->CRL &= ~(GPIO_CRL_CNF1_0);
	
	//Setup PA2:
	GPIOA->CRL &= ~(GPIO_CRL_MODE2_0 | GPIO_CRL_MODE2_1);   //INPUT Mode
	GPIOA->CRL |= (GPIO_CRL_CNF2_1);   //Input Pull-up/Pull-down
	GPIOA->CRL &= ~(GPIO_CRL_CNF2_0);
	
	//Setup PA4:
	GPIOB->CRH |= GPIO_CRL_MODE4;   //OUTPUT Mode 50Mhz
	GPIOB->CRH &= ~(GPIO_CRL_CNF4);   //Output Push-Pull
	
	//Setup PA5:
	GPIOB->CRH |= GPIO_CRL_MODE5;   //OUTPUT Mode 50Mhz
	GPIOB->CRH &= ~(GPIO_CRL_CNF5);   //Output Push-Pull
